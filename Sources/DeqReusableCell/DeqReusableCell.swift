...
extension UITableView {
    ...
    /// - Returns: YourCell的实例
    func dequeueReusableClassCell<T : UITableViewCell>(_ cellType : T.Type, style : UITableViewCell.CellStyle = .default) -> T {
    ...
    /// - Returns: YourCell的实例
    func dequeueReusableNibCell<T : UITableViewCell>(_ cellType : T.Type,owner: Any?) -> T {
        let identifier = cellType.identifier
        var cell = dequeueReusableCell(withIdentifier: identifier)
        if cell == nil {
